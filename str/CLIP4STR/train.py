...
def main(config: DictConfig):
    ...
    if os.path.exists(os.path.join(config.abs_root, "clip4str_huge_3e942729b1.pt")):
        print("Loading pretrained weights from clip4str_huge checkpoint...")
        checkpoint = torch.load(os.path.join(config.abs_root, "clip4str_huge_3e942729b1.pt"))
